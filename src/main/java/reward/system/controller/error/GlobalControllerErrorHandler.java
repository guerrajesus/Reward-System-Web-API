package reward.system.controller.error;
...
@RestControllerAdvice  //Tells Spring its GlobalController
@Slf4j                 //Loger
public class GlobalControllerErrorHandler {
	...
	private ExceptionMessage buildExceptionMessage(//Constructor
